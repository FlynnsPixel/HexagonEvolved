...
#include <core/build/game/Main.h>
...
::core::build::game::ui::UIManager_obj::__register();
::core::build::game::ui::EventButton_obj::__register();
::core::build::game::tools::Trail_obj::__register();
::core::build::game::tools::Point2D_obj::__register();
::core::build::game::tools::ColourChanger_obj::__register();
::core::build::game::tools::Animation_obj::__register();
::core::build::game::stage::StageManager_obj::__register();
::core::build::game::stage::ObstacleManager_obj::__register();
::core::build::game::stage::Obstacle_obj::__register();
::flash::display::Shape_obj::__register();
::core::build::game::managers::Universe_obj::__register();
::core::build::game::managers::ToolManager_obj::__register();
::core::build::game::managers::MouseManager_obj::__register();
::core::build::game::managers::KeyboardManager_obj::__register();
::core::build::game::managers::AssetManager_obj::__register();
::core::build::game::entities::Ship_obj::__register();
::Type_obj::__register();
...
::core::build::game::Main_obj::__register();
...
::core::build::game::Main_obj::__boot();
...
::Type_obj::__boot();
::core::build::game::entities::Ship_obj::__boot();
::core::build::game::managers::AssetManager_obj::__boot();
::core::build::game::managers::KeyboardManager_obj::__boot();
::core::build::game::managers::MouseManager_obj::__boot();
::core::build::game::managers::ToolManager_obj::__boot();
::core::build::game::managers::Universe_obj::__boot();
::flash::display::Shape_obj::__boot();
::core::build::game::stage::Obstacle_obj::__boot();
::core::build::game::stage::ObstacleManager_obj::__boot();
::core::build::game::stage::StageManager_obj::__boot();
::core::build::game::tools::Animation_obj::__boot();
::core::build::game::tools::ColourChanger_obj::__boot();
::core::build::game::tools::Point2D_obj::__boot();
::core::build::game::tools::Trail_obj::__boot();
::core::build::game::ui::EventButton_obj::__boot();
::core::build::game::ui::UIManager_obj::__boot();
