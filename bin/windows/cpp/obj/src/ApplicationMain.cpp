...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("Richman Stewart"),HX_CSTRING("HexagonEvolved"),HX_CSTRING("core.build.game.HexagonEvolved"),HX_CSTRING("1.0.0"));

		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",35);
			{
				HX_STACK_LINE(37)
				...
				HX_STACK_LINE(71)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::core::build::game::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(71)
					while(((_g < _g1->length))){
						HX_STACK_LINE(71)
				...
				if ((hasMain)){
					HX_STACK_LINE(82)
					::Reflect_obj::callMethod(hx::ClassOf< ::core::build::game::Main >(),::Reflect_obj::field(hx::ClassOf< ::core::build::game::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(88)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1080,(int)680,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("HexagonEvolved"),null(),null());
	}
return null();
}
