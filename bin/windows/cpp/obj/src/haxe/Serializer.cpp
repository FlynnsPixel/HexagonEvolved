...
{
HX_STACK_PUSH("Serializer::new","C:\\HaxeToolkit\\haxe/std/haxe/Serializer.hx",99);
{
	HX_STACK_LINE(100)
...
{
		HX_STACK_PUSH("Serializer::serialize","C:\\HaxeToolkit\\haxe/std/haxe/Serializer.hx",223);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(224)
...
{
		HX_STACK_PUSH("Serializer::serializeFields","C:\\HaxeToolkit\\haxe/std/haxe/Serializer.hx",205);
		HX_STACK_THIS(this);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(206)
		{
...
bool Serializer_obj::serializeRef( Dynamic v){
	HX_STACK_PUSH("Serializer::serializeRef","C:\\HaxeToolkit\\haxe/std/haxe/Serializer.hx",168);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(172)
	{
...
{
		HX_STACK_PUSH("Serializer::serializeString","C:\\HaxeToolkit\\haxe/std/haxe/Serializer.hx",149);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(150)
...
::String Serializer_obj::toString( ){
	HX_STACK_PUSH("Serializer::toString","C:\\HaxeToolkit\\haxe/std/haxe/Serializer.hx",114);
	HX_STACK_THIS(this);
	HX_STACK_LINE(114)
