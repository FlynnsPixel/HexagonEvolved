...
{
HX_STACK_PUSH("Main::new","core/build/game/Main.hx",13);
{
	HX_STACK_LINE(13)
	super::__construct();
}
...
Void Main_obj::main( ){
{
		HX_STACK_PUSH("Main::main","core/build/game/Main.hx",15);
		HX_STACK_LINE(16)
		...
		HX_STACK_LINE(18)
		::flash::Lib_obj::get_current()->addChild(::core::build::game::Main_obj::__new());
		HX_STACK_LINE(20)
		::core::build::game::managers::Universe_obj::initiate();
	}
return null();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("core.build.game.Main"), hx::TCanCast< Main_obj> ,sStaticFields,sMemberFields,
