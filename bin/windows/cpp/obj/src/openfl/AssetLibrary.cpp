...
{
HX_STACK_PUSH("AssetLibrary::new","openfl/Assets.hx",1028);
{
}
;
	return null();
...
{
		HX_STACK_PUSH("AssetLibrary::loadSound","openfl/Assets.hx",1140);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
...
{
		HX_STACK_PUSH("AssetLibrary::loadMusic","openfl/Assets.hx",1133);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1133)
...
{
		HX_STACK_PUSH("AssetLibrary::loadMovieClip","openfl/Assets.hx",1126);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1126)
...
{
		HX_STACK_PUSH("AssetLibrary::loadFont","openfl/Assets.hx",1119);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1119)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBytes","openfl/Assets.hx",1112);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1112)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBitmapData","openfl/Assets.hx",1105);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1105)
...
{
		HX_STACK_PUSH("AssetLibrary::load","openfl/Assets.hx",1098);
		HX_STACK_THIS(this);
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(1098)
...
bool AssetLibrary_obj::isLocal( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::isLocal","openfl/Assets.hx",1091);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
...
::flash::media::Sound AssetLibrary_obj::getSound( ::String id){
	HX_STACK_PUSH("AssetLibrary::getSound","openfl/Assets.hx",1084);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1084)
	return null();
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_PUSH("AssetLibrary::getPath","openfl/Assets.hx",1077);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1077)
	return null();
...
::flash::media::Sound AssetLibrary_obj::getMusic( ::String id){
	HX_STACK_PUSH("AssetLibrary::getMusic","openfl/Assets.hx",1070);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1070)
...
::flash::display::MovieClip AssetLibrary_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("AssetLibrary::getMovieClip","openfl/Assets.hx",1063);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1063)
	return null();
...
::flash::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_PUSH("AssetLibrary::getFont","openfl/Assets.hx",1056);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1056)
	return null();
...
::flash::utils::ByteArray AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBytes","openfl/Assets.hx",1049);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1049)
	return null();
...
::flash::display::BitmapData AssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBitmapData","openfl/Assets.hx",1042);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(1042)
	return null();
...
bool AssetLibrary_obj::exists( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::exists","openfl/Assets.hx",1035);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_ARG(type,"type");
	HX_STACK_LINE(1035)
