...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Richman Stewart", "HexagonEvolved", "core.build.game.HexagonEvolved", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (core.build.game.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (core.build.game.Main, Reflect.field (core.build.game.Main, "main"), []);
...
@:keep class DocumentClass extends core.build.game.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HexagonEvolved", null, { width: 1080, height: 680 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1080, height: 680 });
			#end
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (core.build.game.Main, []);
			}
